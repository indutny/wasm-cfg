...
types.forEach(function(type) {
  ...
  bool.forEach(function(op) {
    register(type, op, type, type).result = 'i8';
  });
...
[ 'i32', 'i64', 'f32', 'f64' ].forEach(function(type) {
  ...
  if (type === 'i32' || type === 'i64') {
    ...
    registerEffect('MEMORY_STORE', type, 'store8', 'addr', 'i8');
    registerEffect('MEMORY_STORE', type, 'store16', 'addr', 'i16');
  }
});
...
registerEffect('MEMORY_RESIZE', 'addr', 'resize_memory', 'addr');
