...
function registerControl(result, name, a, b) {
...
[ 'i32', 'i64', 'f32', 'f64' ].forEach(function(type) {
  registerControl(type, 'load', 'addr');
  registerControl(type, 'store', 'addr', type);
  if (type === 'i32' || type === 'i64') {
    registerControl(type, 'load8_s', 'addr');
    registerControl(type, 'load8_u', 'addr');
    registerControl(type, 'load16_s', 'addr');
    registerControl(type, 'load16_u', 'addr');
    registerControl(type, 'store8', 'addr', 'i8');
    registerControl(type, 'store16', 'addr', 'i16');
  }
});
registerControl('i64', 'load32_s', 'addr');
registerControl('i64', 'load32_u', 'addr');
registerControl('i64', 'store32', 'addr', 'i32');

registerControl('addr', 'resize_memory', 'addr');
